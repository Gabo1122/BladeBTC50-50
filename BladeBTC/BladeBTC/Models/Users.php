...
class Users
{
    ...
    /**
     * Get current minimum BTC
     *
     * @return mixed
     */
    public function getCurrentMinimumBTC()
    {
        return $this->_USER->current_minimum_btc;
    }
    ...
    /**
     * Store minimum investment
     *
     * @param $minimum_btc
     * @throws Exception
     */
    public function setCurrentMinimumBTC($minimum_btc)
    {
        try {
            $this->_DB->beginTransaction();
            $this->_DB->query("   UPDATE
                                              `users`
                                            SET 
                                              `current_minimum_btc` = " . $this->_DB->quote($minimum_btc) . "
                                            WHERE
                                                `telegram_id` = " . $this->getTelegramId() . "
                                            ");
            $this->_DB->commit();
     ...
     * @throws Exception
     */
    public function setNullCurrentMinimumBTC()
    {
        try {
            $this->_DB->beginTransaction();
            $this->_DB->query("   UPDATE
